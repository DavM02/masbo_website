...
function ml() {
  const { width: e19, height: t2, isLargeScreen: n2 } = Ia();
  return ue(() => {
    var _a3;
    document.body.classList.contains("overlay-opened") && ((_a3 = za()) == null ? void 0 : _a3.updatePluginOptions("overflow", { open: true }));
  }, [e19, t2, n2]), $("svg", { className: "transition", viewBox: "0 0 3988 3185", preserveAspectRatio: "none", children: $("path", { className: "path", fill: "#E9E9E9", d: "M0 8026.8V3957.5C1307.5 2957.72 2532 2922.72 3988 3960V8026.8C3988 8026.8 3089.5 7146.72 2003 7146.72C916.5 7146.72 0 8026.8 0 8026.8Z", vectorEffect: "non-scaling-stroke" }) });
}
